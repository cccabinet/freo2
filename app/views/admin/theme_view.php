                    ...
                    <div class="card shadow-sm mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                <label class="fw-bold"><?php t($data['name']) ?><?php if ($data['explanation']) : ?> <span class="badge text-bg-secondary" data-bs-toggle="tooltip" title="<?php t($data['explanation']) ?>">？</span><?php endif ?><?php if ($data['required']) : ?> <span class="badge text-bg-danger">必須</span><?php endif ?></label>
