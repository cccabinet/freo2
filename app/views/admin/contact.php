                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php t(MAIN_FILE) ?>/admin/contact_view?id=<?php t($contact['id']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">表示</a>
                                    <?php if ($GLOBALS['authority']['power'] >= 2) : ?>
                                    <a href="<?php t(MAIN_FILE) ?>/admin/contact_form?id=<?php t($contact['id']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">編集</a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <?php endforeach ?>
