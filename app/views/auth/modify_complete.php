    ...
    <main class="col-11 col-md-7 mx-auto my-4">
        ...
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                ...
                <p><a href="<?php t(MAIN_FILE) ?>/admin/home" class="btn btn-secondary" role="button"><?php h($GLOBALS['string']['button_back']) ?></a><p>
                <?php else : ?>
                <p><a href="<?php t(MAIN_FILE) ?>/auth/home" class="btn btn-secondary" role="button"><?php h($GLOBALS['string']['button_back']) ?></a><p>
                <?php endif ?>
            </div>
        </div>
