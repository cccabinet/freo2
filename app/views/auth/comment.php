                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php t(MAIN_FILE) ?>/<?php t($comment['type_code']) ?>/detail/<?php t($comment['entry_code']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">表示</a>
                                <?php elseif ($comment['type_code'] === 'page') : ?>
                                <a href="<?php t(MAIN_FILE) ?>/<?php t($comment['type_code']) ?>/<?php t($comment['entry_code']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">表示</a>
                                <?php elseif ($comment['contact_id']) : ?>
                                <a href="<?php t(MAIN_FILE) ?>/auth/contact_view?id=<?php t($comment['contact_id']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">表示</a>
                                <?php endif ?>
                                <a href="<?php t(MAIN_FILE) ?>/auth/comment_form?id=<?php t($comment['id']) ?>" class="btn btn-primary btn-sm text-nowrap" role="button">編集</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
